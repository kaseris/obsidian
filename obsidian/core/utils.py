...
# @read_file_helper(obsidian.core.config.DEEP_FASHION_SPLITS_PATH)
...
# @read_file_helper(obsidian.core.config.DEEP_FASHION_CLOTHING_LIST_CAT_IMG_PATH)
...
# @read_file_helper(obsidian.core.config.DEEP_FASHION_CLOTHING_LIST_BBOX_IMG_PATH)
...
# @read_file_helper(obsidian.core.config.DEEP_FASHION_CLOTHING_LIST_ATT_IMG_PATH)
